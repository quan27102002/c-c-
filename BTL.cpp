...
public:
  ...
  int main(){
    while(true){
      int choose;
      cout << "Chao mung ban den voi he thong quan ly thu chi   " << endl;
  ...
  cin >> dinhmuc;
    ...
    cout << "\n6.Thoat chuong trinh\n";
      ...
      if(strcmp(password,reinputpassword)){
        cout <<"Mat khau cua ban khong trung khop, vui long nhap lai: ";
      ...
      if(used == 1){
        cout << "Ten dang nhap cua ban da bi su dung,Vui long nhap lai: ";
